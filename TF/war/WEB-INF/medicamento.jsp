...
<body>
	...
	<nav id="menu">
		<div id="menuCenter">
			<div id="nav">
				<ul>
					<li><a href="cJFarma?option=1">INICIO</a>
					</li>
					<li><a href='#'>MEDICAMENTO</a>
						<div>
							<ul>
								<li><a href="cJFarma?option=14">REGISTRAR</a></li>
								<li><a href="cJFarma?option=10">AGREGAR STOCK</a></li>
	...
	<div id="contenido">
		...
		<div class="cuerpoEntrada">
			<form action='/regMedicamento' class='receta' method='get'
				...
				<span class='lf'>Nombre: </span><input required type='text'
					name='nombre'
					pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(\s)*[a-zA-ZñÑáéíóúÁÉÍÓÚ]*"><br>
				<span class='lf'>Selecciona el tipo: </span> <select name='tipo'>
					<option value='oral'>Oral</option>
					<option value='inyectable'>Inyectable</option>
					<option value='pomada'>Pomada</option>
					<option value='tableta'>Tableta</option>
				</select><br> <span class='lf'>Ingrese el stock: </span><input required
					type='number' min='1' name='stock'><br>
