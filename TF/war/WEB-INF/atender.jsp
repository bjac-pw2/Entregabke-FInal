...
<body>
	...
	<div id="contenido">
		<div class="entrada">
			<div class="tituloEntrada">Datos de la Cita</div>
			<div class="cuerpoEntrada">
				<span class='lf'>DNI del Medico: </span>
				<input type="text" name="id" value=<%=session.getAttribute("usuario")%> readonly>
				<span class='lf'>DNI del Paciente: </span>
				<input type="text" name="id" value=<%=request.getAttribute("dni") %> readonly>
				<div>
					<br><a href='cJMedic?option=3'><span class="enviar">RECETA</span></a>
					<a href='cJMedic?option=5'><span class="enviar">GENERAR EXAMEN</span></a>
				</div>
			</div>
		</div>
	</div>
