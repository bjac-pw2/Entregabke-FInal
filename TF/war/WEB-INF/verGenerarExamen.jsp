<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="bjac.GenerarExamen;"%>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<%List<GenerarExamen> citas = (List<GenerarExamen>)request.getAttribute("citas"); %>
</head>
<body>
	<div id="fb-root"></div>
	...
	<div id="contenido">
		...
		<div id="receta">
			<div id="cabecera-r">
				...
				<div id="titulo-r">
					<h2 class="l-h2">GENERAR EXAMEN</h2>
				</div>
			</div>
			<div id="cuerpo-r">
				<div id="datos">
					...
					<div class="row-d-r" id="paciente">
						<div class="primera-c">
							<span class="tt">Datos del Medico que realizara el Examen</span>
						</div>
					</div>
					<div class="row-d-r">
						<div class="primera-c">
							<span class="l-t">DNI: </span><span class="l-c"><%= citas.get(0).getDniMedicoExamen() %></span>
						</div>
					</div>
					<div class="row-d-r" id="paciente">
						<div class="primera-c">
							<span class="tt">Datos Importantes</span>
						</div>
					</div>
					<div class="row-d-r">
						<div class="primera-c">
							<span class="l-t">Fecha: </span><span class="l-c"><%= citas.get(0).getFecha() %></span>
						</div>
						<div class="segunda-c">
							<span class="l-t">Hora: </span><span class="l-c"><%= citas.get(0).getHora() %></span>
						</div>
					</div>
					<div class="row-d-r" id="paciente">
						<div class="primera-c">
							<span class="tt">Descripcion</span>
						</div>
					</div>
					<div class="row-d-r">
						<div class="primera-c">
							<span class="l-c"><%= citas.get(0).getDescripcion() %></span>
						</div>
					</div>
				</div>
			</div>
