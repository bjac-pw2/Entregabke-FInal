...
<body>
	...
	<div id="contenido">
		<div class="tabla">
			<div class="tituloTabla">Asistentes
			</div>
			<div class="cabeza">
			<% List<Asistente> asistentes = (List<Asistente>) request.getAttribute("asistentes");%>
			...
			<%for( Asistente a : asistentes ) {%>
					<div class="row">
						<div class="cell"><p><%= a.getDni() %></p></div>
						<div class="cell"><p><%= a.getNombre() %></p></div>
						<div class="cell"><p><%= a.getApellido() %></p></div>
						<div class="cell"><p><%= a.getGenero() %></p></div>
						<div class="cell"><p><%= a.getEmail() %></p></div>
						<div class="cell"><p><%= a.getDireccion() %></p></div>
						<div class="cell"><p><%= a.getTelefono() %></p></div>
					</div>
			<%}%>
		</div>	
	</div>
